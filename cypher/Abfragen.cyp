...
// Zusammenfassungen der Warnbriefe, chronologisch sortiert
MATCH (l:Letter)-[:TYPE]->(t:Type {type:'Warnung'})
RETURN l.startdate AS Datum, l.source AS Zusammenfassung ORDER BY Datum;
